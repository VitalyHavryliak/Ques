                ...
                <div class="row">
                    <div class="offset-lg-2 col-lg-8">
                        <div class="title-01 title-01--11 text-center">
                            ...
                            <div class="title__action"><a href="#" class="btn btn-success">Розпочнемо?</a></div>
                        </div> <!-- .title-01 -->
                    </div>
                </div>
            </div>
...
<div class="button-group">
    <a href="#" class="btn btn-outline-success button-sm">Color</a>
    <a href="#" class="btn btn-outline-success button-sm">Slider</a>
    <a href="#" class="btn btn-outline-success button-sm">Video Background</a>
</div>
